...
#             pass
    ...
    os.system("chroot /mnt/ xbps-reconfigure -fa")
    ...
    os.system("xbps-install -Sy -R https://alpha.de.repo.voidlinux.org/current -r /mnt wget git python python-pip")
    ...
    os.system("chroot /mnt/ pip install colorama requests")
    ...
    if atomic is True:
        ...
        if network_supplier == 1:
            os.system("xbps-install -Sy -R https://alpha.de.repo.voidlinux.org/current -r /mnt iwd")
            os.system("chroot /mnt/ systemctl enable iwd")
